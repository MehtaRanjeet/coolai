  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl shadow-black/40 w-full max-w-md p-10 animate-fadeUp">
        ...
        <p className="text-ink/50 mb-8">Create your account to get started.</p>
        ...
        <p className="mt-6 text-center text-sm text-ink/50">
          ...
          <Link to="/login" className="text-cool-600 font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
